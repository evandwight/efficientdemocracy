...
export const Page = () =>
    <div>
        ...
        <ul>
            ...
            <li>
                <a href={C.URLS.ABOUT_COSTS}>Being optimized for users, not investors</a>: our goal is to keep costs low and not take outside investment as <a href="http://johncbogle.com/wordpress/wp-content/uploads/2009/04/columbia409.pdf">a man cannot serve two masters"[pdf]</a>.
            </li>
        </ul>
    </div>
