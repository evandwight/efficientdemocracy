...
export const Page = () =>
    <div className="about-text">
        ...
        <p>
            Not all votes are the same. Users are held responsible for unsolicited votes (up votes, down votes, disputes) but not for solicted votes (samples, referendums) as we don't want to discourage participation.</p>
    </div>
